...
The transcription request contains a dictionary customProperties where a entry must be added `{ "customDppEnabled": "True" }`. Below an example using C#, other languages are similar:
